...
def sobel_edge_detection(image, ksize, direction):
    ...
    # Apply Sobel based on direction
    if direction == 'X':
...
if uploaded_file is not None:
    ...
    # PIL uses RGB, OpenCV uses BGR. We convert to RGB for consistency.
    ...
    # Display a placeholder message until an image is uploaded
